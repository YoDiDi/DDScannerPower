...
from py.mw.common.Unauthorizeservice import Services
...
class ModeWidget5(QWidget):
    ...
    def initUI(self):
        ...
        self.cb.addItem("MongoDB")
        self.cb.addItem("Redis")
        self.cb.addItem("Elasticsearch")
